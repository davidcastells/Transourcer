...
public class StreamTokenizer {
    ...
    //@dcr
    boolean generatePreprocessorTokens = true;
...
//                return nextToken();
    ...
    private int readPreprocessorLine() throws IOException
    {
        String s = "";
    ...
    public String untokenizedStream() throws IOException
    {
        StringBuilder sb = new StringBuilder();
        int c = read();
